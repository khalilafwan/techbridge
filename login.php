            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-5">
                    <div class="card login-card p-4">
                        <h2 class="mb-4" style="color: var(--primary-blue); font-weight: bold; text-align:center">Log In</h2>
                        <form method="POST" action="">
                            ...
                            <button type="submit" class="btn login-btn w-50 mb-3">Login</button>
                            <div class="text-center">
                                <span class="text-muted">Don't have Account ? </span>
                                <a href="register.php" style="color: var(--primary-orange); text-decoration: none;">Register Here</a>
                            </div>
                ...
                <!-- Illustration Column -->
                <div class="col-md-7">
                    <img src="assets/img/techbridge/login.png" class="img-fluid" alt="Online Learning Illustration">
                </div>
            </div>
        </div>
    </main>
